...
//         if (
//             (
//                 restaurantData.name.toLowerCase().includes(searchKey.toLowerCase().trim()) ||
//                 restaurantData.address.toLowerCase().includes(searchKey.toLocaleLowerCase().trim()) ||
//                 restaurantData["address line 2"].toLowerCase().includes(searchKey.toLocaleLowerCase().trim()))
...
//     //             <input onChange={onSearchBoxChange} type="text" placeholder="Search restaurants..." />
//     //             <div>
//     //                 Minimum Rating<input onChange={onRatingBoxChange} type="number" />
//     //             </div>
//     //         </div>
